...
public class RaccoonSkills : MonoBehaviour, SkillInterface
{
    ...
    public bool subHealth(int value)
    {
        ...
        if (i >= 0.3f)
        {
            ...
            Tester.Log("Raccoon CurHealth: " + Stats.CurHealth);
            return true;
        }
    ...
    public void startTurn()
    {
        ...
        if (Stats.PoisonCooldown > 3)
        {
            ...
            Tester.Log("The Raccoon is no longer poisoned!");
        }
        ...
        if (Stats.DistractedCooldown > 1)
        {
            ...
            Tester.Log("The Raccoon is no longer distracted!");
        }
        ...
        if (Stats.IsAfraid)
        {
            ...
            if (i >= 0.5f)
            {
                ...
                Tester.Log("The Raccoon surpassed its fear this turn!");
            }
        }
    ...
    public void endTurn()
    {
        ...
        if (Stats.IsPoisoned)
        {
            ...
            Stats.PoisonDamage();
            Tester.Log("The Raccoon is poisoned! Its CurHP is " + Stats.CurHealth);
        }

        if (Stats.IsDistracted)
        {
            Tester.Log("The Raccoon is distracted!");
            Stats.DistractedCooldown++;
        }

        if (Stats.IsAfraid)
        {
            Tester.Log("The Raccoon is afraid!");
        }

        if (Stats.IsInvulnerable)
        {
            Tester.Log("The Raccoon is invulnerable!");
        }
