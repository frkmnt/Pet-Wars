...
public class LizardSkills : MonoBehaviour, SkillInterface
{
    ...
    public bool subHealth(int value)
    {
        ...
        if (i >= 0.3f)
        {
            ...
            Tester.Log("Lizard CurHealth: " + Stats.CurHealth);
            return true;
        }
    ...
    public bool turnSkill()
    {
            ...
            if (cooldown == 0) 
            {
                ...
                Tester.Log("The Lizard Healed! Its CurHp is " + Stats.CurHealth);
                return true;
            }

            Tester.Log("The Lizard wasn't able to heal!");
            return false;
    }
    ...
    public void startTurn()
    {
        ...
        if (Stats.PoisonCooldown > 3)
        {
            ...
            Tester.Log("The Lizard is no longer poisoned!");
        }
        ...
        if (Stats.DistractedCooldown > 1)
        {
            ...
            Tester.Log("The Lizard is no longer distracted!");
        }
        ...
        if (Stats.IsAfraid)
        {
            ...
            if (i >= 0.5f)
            {
                ...
                Tester.Log("The Lizard surpassed its fear this turn!");
            }
        }
    ...
    public void endTurn()
    {
        ...
        if (Stats.IsPoisoned)
        {
            ...
            Stats.PoisonDamage();
            Tester.Log("The Lizard is poisoned! Its CurHP is " + Stats.CurHealth);
        }

        if (Stats.IsDistracted)
        {
            Tester.Log("The Lizard is distracted!");
            Stats.DistractedCooldown++;
        }

        if (Stats.IsAfraid)
        {
            Tester.Log("The Lizard is afraid!");
        }

        if (Stats.IsInvulnerable)
        {
            Tester.Log("The Lizard is invulnerable!");
        }
