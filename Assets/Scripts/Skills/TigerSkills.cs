...
public class TigerSkills : MonoBehaviour, SkillInterface {
    ...
    public bool subHealth(int value)
    {
        ...
        if (i >= 0.3f)
        {
            ...
            Tester.Log("Tiger CurHealth: " + Stats.CurHealth);
            return true;
        }
    ...
    public void startTurn()
    {
        ...
        if (Stats.PoisonCooldown > 3)
        {
            ...
            Tester.Log("The Tiger is no longer poisoned!");
        }
        ...
        if (Stats.DistractedCooldown > 1)
        {
            ...
            Tester.Log("The Tiger is no longer distracted!");
        }
        ...
        if (Stats.IsAfraid)
        {
            ...
            if (i >= 0.5f)
            {
                ...
                Tester.Log("The Tiger surpassed its fear this turn!");
            }
        }
    ...
    public void endTurn()
    {
        ...
        if (Stats.IsPoisoned)
        {
            ...
            Stats.PoisonDamage();
            Tester.Log("The Tiger is poisoned! Its CurHP is " + Stats.CurHealth);
        }

        if (Stats.IsDistracted)
        {
            Tester.Log("The Tiger is distracted!");
            Stats.DistractedCooldown++;
        }

        if (Stats.IsAfraid)
        {
            Tester.Log("The Tiger is afraid!");
        }

        if (Stats.IsInvulnerable)
        {
            Tester.Log("The Tiger is invulnerable!");
        }
