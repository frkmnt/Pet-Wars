...
public class CatFatSkills : MonoBehaviour, SkillInterface
{
    ...
    public bool subHealth(int value)
    {
        ...
        if (i >= 0.3f)
        {
            ...
            Tester.Log("Fat Cat CurHealth: " + Stats.CurHealth);
            return true;
        }
    ...
    public void startTurn()
    {
        ...
        if (Stats.PoisonCooldown > 3)
        {
            ...
            Tester.Log("The Fat Cat is no longer poisoned!");
        }
        ...
        if (Stats.DistractedCooldown > 1)
        {
            ...
            Tester.Log("The Fat Cat is no longer distracted!");
        }
        ...
        if (Stats.IsAfraid)
        {
            ...
            if (i >= 0.5f)
            {
                ...
                Tester.Log("The Fat Cat surpassed its fear this turn!");
            }
        }
    ...
    public void endTurn()
    {
        ...
        if (Stats.IsPoisoned)
        {
            ...
            Stats.PoisonDamage();
            Tester.Log("The Fat Cat is poisoned! Its CurHP is " + Stats.CurHealth);
        }

        if (Stats.IsDistracted)
        {
            Tester.Log("The Fat Cat is distracted!");
            Stats.DistractedCooldown++;
        }

        if (Stats.IsAfraid)
        {
            Tester.Log("The Fat Cat is afraid!");
        }

        if (Stats.IsInvulnerable)
        {
            Tester.Log("The Fat Cat is invulnerable!");
        }
