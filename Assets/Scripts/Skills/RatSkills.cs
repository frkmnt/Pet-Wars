...
public class RatSkills : MonoBehaviour, SkillInterface {
    ...
    public void FindTester()
    {
        ...
        if (l) 
        {
            Tester = l.GetComponent<PetLogger>();
            Debug.Log(Tester);
        }
    }
    ...
    public bool subHealth(int value)
    {
        ...
        if (i >= 0.3f)
        {
            ...
            Tester.Log("Rat CurHealth: " + Stats.CurHealth);
            return true;
        }
    ...
    public void startTurn()
    {
        ...
        if (Stats.PoisonCooldown > 3)
        {
            ...
            Tester.Log("The Rat is no longer poisoned!");
        }
        ...
        if (Stats.DistractedCooldown > 1)
        {
            ...
            Tester.Log("The Rat is no longer distracted!");
        }
        ...
        if (Stats.IsAfraid)
        {
            ...
            if (i >= 0.5f)
            {
                ...
                Tester.Log("The Rat surpassed its fear this turn!");
            }
        }
    ...
    public void endTurn()
    {
        ...
        if (Stats.IsPoisoned)
        {
            ...
            Stats.PoisonDamage();
            Tester.Log("The Rat is poisoned! Its CurHP is " + Stats.CurHealth);
        }

        if (Stats.IsDistracted)
        {
            Tester.Log("The Rat is distracted!");
            Stats.DistractedCooldown++;
        }

        if (Stats.IsAfraid)
        {
            Tester.Log("The Rat is afraid!");
        }

        if (Stats.IsInvulnerable)
        {
            Tester.Log("The Rat is invulnerable!");
        }
